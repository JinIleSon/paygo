...
import { IconCreditCard, IconWallet, IconShoppingCart, IconChartBar, IconBrandGoogle } from '@tabler/icons-react';
    ...
    return (
        <AuthLayout>
            <div className='flex h-screen min-w-[1280px]'>
                ...
                <div className='flex-[5.5] text-center content-center border-l border-[#D9D9D9] border-solid bg-[#fafafa]'>
                        ...
                        <div className='mt-5 text-[#bdb6b1] font-medium'>
                            ...
                            <div className='mt-6'>
                                <button className='flex items-center justify-center gap-1.5 w-full h-[50px] rounded-md border border-[#D9D9D9] bg-white'>
                                    <IconBrandGoogle size={20} color='#666666'/><span className='text-[14px] text-[#666666]'>Google로 계속하기</span>
                                </button>
                            </div>
                            <div className='text-xs text-center mt-6'>
                                <span className='mr-1'>아직 계정이 없으신가요?</span>
                                <a href="#"
                                className='text-[#6365EF] font-medium underline'>회원가입</a>
                            </div>
                        </div>
                    </div>
                </div>
